...
const App = () => {
  ...
  return (
    <div>
      <div
        ref={boom}
        className="h-screen place-items-center content-center bg-[url('../public/benjamin-davies-332625-unsplash.jpg')] bg-cover bg-center opacity-80"
      >
        <div
          id='king'
          className='max-w-screen pt-24 text-2xl font-bold max-md:text-xl'
        >
          Life is{' '}
          <span id='ding' className='text-4xl font-bold text-red-600'>
            Un
          </span>
          <span ref={ding} className='font-bold'>
            Fair
          </span>
        </div>
      </div>
      <div className='relative'>
        ...
        <div className='grid grid-cols-6 grid-rows-3 gap-3 max-md:grid-cols-4'>
          <img
            ...
            src='https://i.pinimg.com/webp85/1200x/85/a6/99/85a69912405712de7ecd3762c2d860ac.webp'
            alt=''
          ...
          <img
            ...
            src='https://i.pinimg.com/1200x/af/d6/b3/afd6b322606601bf743d27a1e75b9b12.jpg'
            alt=''
            className='col-start-4 h-full w-full min-md:col-start-5'
          />

          <div className='col-start-6 col-end-6 row-span-3 max-md:hidden'>
            <div className='sticky top-0 flex h-screen flex-col p-2 text-2xl font-bold text-wrap'>
              "Fair hoti zindagi to sab successful hote. Aur woh{' '}
              <span className='text-red-600'>BORING</span> hotta."
              <span className='mt-4'>
                Cheers to dukh dard peeda — but hasne mein hi maza hai.
              </span>
            </div>
          </div>
          ...
          <img
            ...
            src='https://i.pinimg.com/webp85/736x/7f/b6/05/7fb60538564ceef755080d388a5148ea.webp'
            className='col-start-1 row-start-3 h-full w-full'
            alt=''
          />
          <img
            ref={el => (imgs.current[3] = el)}
            src='https://i.pinimg.com/736x/21/5f/f4/215ff49d5e0fb8590a7bb975c754ed57.jpg'
            alt=''
            className='col-start-4 row-start-3 h-full w-full min-md:col-start-5'
          />
        </div>
      </div>
      ...
      <div className='place-items-center content-center overflow-x-clip'>
        ...
        <h1 ref={vd} className='text-2xl font-bold text-red-600'>
          The king is back Lorem ipsum dolor sit amet consectetur adipisicing
          elit.
        </h1>
        <h1 ref={cd} className='text-2xl font-bold text-black'>
          Get the fuck of Lorem ipsum dolor sit amet consectetur, adipisicing
          elit.
        </h1>
      </div>
    </div>
